...
public:
    ...
    void addItemsToInventory(int id, int amount, const std::map<int, std::string>& items_all) {
        if (dead) return;
        std::cout << "[" << name << "]" << " ";
        inventory.addItems(id, amount, items_all);
    }

    void removeItemsFromInventory(int id, int amount, const std::map<int, std::string>& items_all) {
        if (dead) return;
        std::cout << "[" << name << "]" << " ";
